...
function [] = RUN_PE_COVID19_NoOver_V2_NoInfected(resultBase,nThetaGuesses,expdata)
    ...
    param_including_vector = [false,true,true,false,false,false,false,false,false,false,false,...
    ...
    param = Params_SIR_NoInfected([],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]); % Default theta vector, need to see how to modify this deppending on what do we wanna do
    ...
    parfor epcc_exps=1:nThetaGuesses
        ...
        if ~ismember(m,fi)
            ...
            try
                ...
                [out] = PE_COVID19_NoOver_V2_NoInfected(epccOutputResultFileNameBase,epcc_exps,global_theta_guess,expdata,theta);
            catch err
                %open file
