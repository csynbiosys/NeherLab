function [model] = COVID19_NeherModel_V4_NoOver2_Tested()
...
model.n_st=11*9+9;                                                               % Number of states      
model.n_par=47+1;                                                             % Number of model parameters 
...
model.st_names=char('Sus_0','Exp1_0','Exp2_0','Exp3_0','Inf_0','Tes_0','Sev_0','Cri_0','Rec_0','Fat_0','CumHos_0','CumCri_0', ...
                    'Sus_1','Exp1_1','Exp2_1','Exp3_1','Inf_1','Tes_1','Sev_1','Cri_1','Rec_1','Fat_1','CumHos_1','CumCri_1', ...
                    'Sus_2','Exp1_2','Exp2_2','Exp3_2','Inf_2','Tes_2','Sev_2','Cri_2','Rec_2','Fat_2','CumHos_2','CumCri_2', ...
                    'Sus_3','Exp1_3','Exp2_3','Exp3_3','Inf_3','Tes_3','Sev_3','Cri_3','Rec_3','Fat_3','CumHos_3','CumCri_3', ...
                    'Sus_4','Exp1_4','Exp2_4','Exp3_4','Inf_4','Tes_4','Sev_4','Cri_4','Rec_4','Fat_4','CumHos_4','CumCri_4', ...
                    'Sus_5','Exp1_5','Exp2_5','Exp3_5','Inf_5','Tes_5','Sev_5','Cri_5','Rec_5','Fat_5','CumHos_5','CumCri_5', ...
                    'Sus_6','Exp1_6','Exp2_6','Exp3_6','Inf_6','Tes_6','Sev_6','Cri_6','Rec_6','Fat_6','CumHos_6','CumCri_6', ...
                    'Sus_7','Exp1_7','Exp2_7','Exp3_7','Inf_7','Tes_7','Sev_7','Cri_7','Rec_7','Fat_7','CumHos_7','CumCri_7', ...
                    'Sus_8','Exp1_8','Exp2_8','Exp3_8','Inf_8','Tes_8','Sev_8','Cri_8','Rec_8','Fat_8','CumHos_8','CumCri_8');      % Names of the states     

model.par_names=char('Npop','R_0','epp','ipd','ofs','HB','ICUb','t_i','t_l','t_c', 't_h','report',...
...
model.eqns=...                                                              % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('bet = R_0*(1+epp*COS)/t_i',...
                    ...
                    'dTes_0 = (((3*Exp3_0)/t_l) - (Inf_0/t_i))*report',...
                    ...
                    'dTes_1 = (((3*Exp3_1)/t_l) - (Inf_1/t_i))*report',...
                    ...
                    'dTes_2 = (((3*Exp3_2)/t_l) - (Inf_2/t_i))*report',...
                    ...
                    'dTes_3 = (((3*Exp3_3)/t_l) - (Inf_3/t_i))*report',...
                    ...
                    'dTes_4 = (((3*Exp3_4)/t_l) - (Inf_4/t_i))*report',...
                    ...
                    'dTes_5 = (((3*Exp3_5)/t_l) - (Inf_5/t_i))*report',...
                    ...
                    'dTes_6 = (((3*Exp3_6)/t_l) - (Inf_6/t_i))*report',...
                    ...
                    'dTes_7 = (((3*Exp3_7)/t_l) - (Inf_7/t_i))*report',...
                    ...
                    'dTes_8 = (((3*Exp3_8)/t_l) - (Inf_8/t_i))*report',...
