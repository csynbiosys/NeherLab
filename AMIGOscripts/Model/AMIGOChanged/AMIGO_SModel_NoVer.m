function [results]=AMIGO_SModel_NoVer(input_file,run_ident)
...
[inputs,results]=AMIGO_check_model_NoVer(input_file,inputs_def);


[inputs,results]=AMIGO_check_exps_NoVer(inputs,results);
