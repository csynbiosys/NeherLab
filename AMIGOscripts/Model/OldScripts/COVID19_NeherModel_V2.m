...
model.eqns=...                                                              % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('bet = R_00*M_t*(1+epp*cosphase)/t_i',...
                    ...
                    ...
                    'flux_S0   = (ze_0*bet)*(I_all/Npop)*S_0 + (0/9)',...
                    ...
                    'dD_0 =  +flux_C_D0',...
                    ...
                    'flux_S1   = (ze_1*bet)*(I_all/Npop)*S_1 + (0/9)',...
                    ...
                    'dD_1 =  +flux_C_D1',...
                    ...
                    'flux_S2   = (ze_2*bet)*(I_all/Npop)*S_2 + (0/9)',...
                    ...
                    'dD_2 =  +flux_C_D2',...
                    ...
                    'flux_S3   = (ze_3*bet)*(I_all/Npop)*S_3 + (0/9)',...
                    ...
                    'dD_3 =  +flux_C_D3',...
                    ...
                    'flux_S4   = (ze_4*bet)*(I_all/Npop)*S_4 + (0/9)',...
                    ...
                    'dD_4 =  +flux_C_D4',...
                    ...
                    'flux_S5   = (ze_5*bet)*(I_all/Npop)*S_5 + (0/9)',...
                    ...
                    'dD_5 =  +flux_C_D5',...
                    ...
                    'flux_S6   = (ze_6*bet)*(I_all/Npop)*S_6 + (0/9)',...
                    ...
                    'dD_6 =  +flux_C_D6',...
                    ...
                    'flux_S7   = (ze_7*bet)*(I_all/Npop)*S_7 + (0/9)',...
                    ...
                    'dD_7 =  +flux_C_D7',...
                    ...
                    'flux_S8   = (ze_8*bet)*(I_all/Npop)*S_8 + (0/9)',...
...
model.par=[330000000,3.2,0.1,cp,3,3,14,3,...
          1-isolated(1),severe(1),critical(1),fatality(1),...
          1-isolated(2),severe(2),critical(2),fatality(2),...
          1-isolated(3),severe(3),critical(3),fatality(3),...
          1-isolated(4),severe(4),critical(4),fatality(4),...
          1-isolated(5),severe(5),critical(5),fatality(5),...
          1-isolated(6),severe(6),critical(6),fatality(6),...
          1-isolated(7),severe(7),critical(7),fatality(7),...
          1-isolated(8),severe(8),critical(8),fatality(8),...
          1-isolated(9),severe(9),critical(9),fatality(9)];  
