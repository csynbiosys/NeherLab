function [model] = COVID19_NeherModel_V3_Over_if()
...
model.eqns=...                                                              % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('bet = R_0*(1+epp*COS)/t_i',...
                    ...
                    'if(freeICUb<0)',...
                    '    if(Cri_8 > -freeICUb)',...
                    '        Cri_8 = Cri_8+freeICUb;Ovf_8 = Ovf_8-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_8 = Ovf_8+Cri_8;freeICUb = freeICUb+Cri_8;Cri_8 = 0;',...
                    '    end',...
                    '    if(Cri_7 > -freeICUb)',...
                    '        Cri_7 = Cri_7+freeICUb;Ovf_7 = Ovf_7-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_7 = Ovf_7+Cri_7;freeICUb = freeICUb+Cri_7;Cri_7 = 0;',...
                    '    end',...
                    '    if(Cri_6 > -freeICUb)',...
                    '        Cri_6 = Cri_6+freeICUb;Ovf_6 = Ovf_6-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_6 = Ovf_6+Cri_6;freeICUb = freeICUb+Cri_6;Cri_6 = 0;',...
                    '    end',...
                    '    if(Cri_5 > -freeICUb)',...
                    '        Cri_5 = Cri_5+freeICUb;Ovf_5 = Ovf_5-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_5 = Ovf_5+Cri_5;freeICUb = freeICUb+Cri_5;Cri_5 = 0;',...
                    '    end',...
                    '    if(Cri_4 > -freeICUb)',...
                    '        Cri_4 = Cri_4+freeICUb;Ovf_4 = Ovf_4-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_4 = Ovf_4+Cri_4;freeICUb = freeICUb+Cri_4;Cri_4 = 0;',...
                    '    if(Cri_3 > -freeICUb)',...
                    '        Cri_3 = Cri_3+freeICUb;Ovf_3 = Ovf_3-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_3 = Ovf_3+Cri_3;freeICUb = freeICUb+Cri_3;Cri_3 = 0;',...
                    '    if(Cri_2 > -freeICUb)',...
                    '        Cri_2 = Cri_2+freeICUb;Ovf_2 = Ovf_2-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_2 = Ovf_2+Cri_2;freeICUb = freeICUb+Cri_2;Cri_2 = 0;',...
                    '    end',...
                    '    if(Cri_1 > -freeICUb)',...
                    '        Cri_1 = Cri_1+freeICUb;Ovf_1 = Ovf_1-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_1 = Ovf_1+Cri_1;freeICUb = freeICUb+Cri_1;Cri_1 = 0;',...
                    '    end',...
                    '    if(Cri_0 > -freeICUb)',...
                    '        Cri_0 = Cri_0+freeICUb;Ovf_0 = Ovf_0-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Ovf_0 = Ovf_0+Cri_0;freeICUb = freeICUb+Cri_0;Cri_0 = 0;',...
                    '    end',...
                    'end',...
                    'if(freeICUb>0)',...
                    '    if(Ovf_0>freeICUb)',...
                    '        Cri_0 = Cri_0+freeICUb;Ovf_0 = Ovf_0-freeICUb;freeICUb = 0;',...
                    '    else',...
                    '        Cri_0 = Cri_0+Ovf_0;freeICUb = freeICUb-Ovf_0;Ovf_0 = 0;',...
                    '    end',...
                    '    if(Ovf_1>freeICUb)',...
                    '        Cri_1 = Cri_1+freeICUb;Ovf_1 = Ovf_1-freeICUb;freeICUb = 1;',...
                    '    else',...
                    '        Cri_1 = Cri_1+Ovf_1;freeICUb = freeICUb-Ovf_1;Ovf_1 = 0;',...
                    '    end',...
                    '    if(Ovf_2>freeICUb)',...
                    '        Cri_2 = Cri_2+freeICUb;Ovf_2 = Ovf_2-freeICUb;freeICUb = 2;',...
                    '    else',...
                    '        Cri_2 = Cri_2+Ovf_2;freeICUb = freeICUb-Ovf_2;Ovf_2 = 0;',...
                    '    end',...
                    '    if(Ovf_3>freeICUb)',...
                    '        Cri_3 = Cri_3+freeICUb;Ovf_3 = Ovf_3-freeICUb;freeICUb = 3;',...
                    '    else',...
                    '        Cri_3 = Cri_3+Ovf_3;freeICUb = freeICUb-Ovf_3;Ovf_3 = 0;',...
                    '    end',...
                    '    if(Ovf_4>freeICUb)',...
                    '        Cri_4 = Cri_4+freeICUb;Ovf_4 = Ovf_4-freeICUb;freeICUb = 4;',...
                    '    else',...
                    '        Cri_4 = Cri_4+Ovf_4;freeICUb = freeICUb-Ovf_4;Ovf_4 = 0;',...
                    '    end',...
                    '    if(Ovf_5>freeICUb)',...
                    '        Cri_5 = Cri_5+freeICUb;Ovf_5 = Ovf_5-freeICUb;freeICUb = 5;',...
                    '    else',...
                    '        Cri_5 = Cri_5+Ovf_5;freeICUb = freeICUb-Ovf_5;Ovf_5 = 0;',...
                    '    end',...
                    '    if(Ovf_6>freeICUb)',...
                    '        Cri_6 = Cri_6+freeICUb;Ovf_6 = Ovf_6-freeICUb;freeICUb = 6;',...
                    '    else',...
                    '        Cri_6 = Cri_6+Ovf_6;freeICUb = freeICUb-Ovf_6;Ovf_6 = 0;',...
                    '    end',...
                    '    if(Ovf_7>freeICUb)',...
                    '        Cri_7 = Cri_7+freeICUb;Ovf_7 = Ovf_7-freeICUb;freeICUb = 7;',...
                    '    else',...
                    '        Cri_7 = Cri_7+Ovf_7;freeICUb = freeICUb-Ovf_7;Ovf_7 = 0;',...
                    '    end',...
                    '    if(Ovf_8>freeICUb)',...
                    '        Cri_8 = Cri_8+freeICUb;Ovf_8 = Ovf_8-freeICUb;freeICUb = 8;',...
                    '    else',...
                    '        Cri_8 = Cri_8+Ovf_8;freeICUb = freeICUb-Ovf_8;Ovf_8 = 0;',...
                    '    end',...
                    'end',...
                    ...
...
% 'if(Sus_0<0){Sus_0=0;}',...
%                     'if(Exp1_0<0){Exp1_0=0;}',...
%                     'if(Exp2_0<0){Exp2_0=0;}',...
%                     'if(Exp3_0<0){Exp3_0=0;}',...
%                     'if(Inf_0<0){Inf_0=0;}',...
%                     'if(Sev_0<0){Sev_0=0;}',...
%                     'if(Ovf_0<0){Ovf_0=0;}',...
%                     'if(Rec_0<0){Rec_0=0;}',...
%                     'if(CumHos_0<0){CumHos_0=0;}',...
%                     'if(CumCri_0<0){CumCri_0=0;}',...
%                     ...
%                     'if(Sus_1<0){Sus_1=0;}',...
%                     'if(Exp1_1<0){Exp1_1=0;}',...
%                     'if(Exp2_1<0){Exp2_1=0;}',...
%                     'if(Exp3_1<0){Exp3_1=0;}',...
%                     'if(Inf_1<0){Inf_1=0;}',...
%                     'if(Sev_1<0){Sev_1=0;}',...
%                     'if(Ovf_1<0){Ovf_1=0;}',...
%                     'if(Rec_1<0){Rec_1=0;}',...
%                     'if(CumHos_1<0){CumHos_1=0;}',...
%                     'if(CumCri_1<0){CumCri_1=0;}',...
%                     ...
%                     'if(Sus_2<0){Sus_2=0;}',...
%                     'if(Exp1_2<0){Exp1_2=0;}',...
%                     'if(Exp2_2<0){Exp2_2=0;}',...
%                     'if(Exp3_2<0){Exp3_2=0;}',...
%                     'if(Inf_2<0){Inf_2=0;}',...
%                     'if(Sev_2<0){Sev_2=0;}',...
%                     'if(Ovf_2<0){Ovf_2=0;}',...
%                     'if(Rec_2<0){Rec_2=0;}',...
%                     'if(CumHos_2<0){CumHos_2=0;}',...
%                     'if(CumCri_2<0){CumCri_2=0;}',...
%                     ...
%                     'if(Sus_3<0){Sus_3=0;}',...
%                     'if(Exp1_3<0){Exp1_3=0;}',...
%                     'if(Exp2_3<0){Exp2_3=0;}',...
%                     'if(Exp3_3<0){Exp3_3=0;}',...
%                     'if(Inf_3<0){Inf_3=0;}',...
%                     'if(Sev_3<0){Sev_3=0;}',...
%                     'if(Ovf_3<0){Ovf_3=0;}',...
%                     'if(Rec_3<0){Rec_3=0;}',...
%                     'if(CumHos_3<0){CumHos_3=0;}',...
%                     'if(CumCri_3<0){CumCri_3=0;}',...
%                     ...
%                     'if(Sus_4<0){Sus_4=0;}',...
%                     'if(Exp1_4<0){Exp1_4=0;}',...
%                     'if(Exp2_4<0){Exp2_4=0;}',...
%                     'if(Exp3_4<0){Exp3_4=0;}',...
%                     'if(Inf_4<0){Inf_4=0;}',...
%                     'if(Sev_4<0){Sev_4=0;}',...
%                     'if(Ovf_4<0){Ovf_4=0;}',...
%                     'if(Rec_4<0){Rec_4=0;}',...
%                     'if(CumHos_4<0){CumHos_4=0;}',...
%                     'if(CumCri_4<0){CumCri_4=0;}',...
%                     ...
%                     'if(Sus_5<0){Sus_5=0;}',...
%                     'if(Exp1_5<0){Exp1_5=0;}',...
%                     'if(Exp2_5<0){Exp2_5=0;}',...
%                     'if(Exp3_5<0){Exp3_5=0;}',...
%                     'if(Inf_5<0){Inf_5=0;}',...
%                     'if(Sev_5<0){Sev_5=0;}',...
%                     'if(Ovf_5<0){Ovf_5=0;}',...
%                     'if(Rec_5<0){Rec_5=0;}',...
%                     'if(CumHos_5<0){CumHos_5=0;}',...
%                     'if(CumCri_5<0){CumCri_5=0;}',...
%                     ...
%                     'if(Sus_6<0){Sus_6=0;}',...
%                     'if(Exp1_6<0){Exp1_6=0;}',...
%                     'if(Exp2_6<0){Exp2_6=0;}',...
%                     'if(Exp3_6<0){Exp3_6=0;}',...
%                     'if(Inf_6<0){Inf_6=0;}',...
%                     'if(Sev_6<0){Sev_6=0;}',...
%                     'if(Ovf_6<0){Ovf_6=0;}',...
%                     'if(Rec_6<0){Rec_6=0;}',...
%                     'if(CumHos_6<0){CumHos_6=0;}',...
%                     'if(CumCri_6<0){CumCri_6=0;}',...
%                     ...
%                     'if(Sus_7<0){Sus_7=0;}',...
%                     'if(Exp1_7<0){Exp1_7=0;}',...
%                     'if(Exp2_7<0){Exp2_7=0;}',...
%                     'if(Exp3_7<0){Exp3_7=0;}',...
%                     'if(Inf_7<0){Inf_7=0;}',...
%                     'if(Sev_7<0){Sev_7=0;}',...
%                     'if(Ovf_7<0){Ovf_7=0;}',...
%                     'if(Rec_7<0){Rec_7=0;}',...
%                     'if(CumHos_7<0){CumHos_7=0;}',...
%                     'if(CumCri_7<0){CumCri_7=0;}',...
%                     ...
%                     'if(Sus_8<0){Sus_8=0;}',...
%                     'if(Exp1_8<0){Exp1_8=0;}',...
%                     'if(Exp2_8<0){Exp2_8=0;}',...
%                     'if(Exp3_8<0){Exp3_8=0;}',...
%                     'if(Inf_8<0){Inf_8=0;}',...
%                     'if(Sev_8<0){Sev_8=0;}',...
%                     'if(Ovf_8<0){Ovf_8=0;}',...
%                     'if(Rec_8<0){Rec_8=0;}',...
%                     'if(CumHos_8<0){CumHos_8=0;}',...
%                     'if(CumCri_8<0){CumCri_8=0;}',...
%                     ...                
