function [model] = COVID19_NeherModel_V3_NoOver()
...
model.par_names=char('Npop','R_0','epp','peak','pi','ipd','ofs','t_i','t_l','t_c', 't_h',...
...
model.eqns=...                                                              % Equations describing system dynamics. Time derivatives are regarded 'd'st_name''
               char('cosphase = cos(2*pi*(((t+1)/365)-(peak/365)))',...
                    'bet = R_0*(ze_a0)*(1+epp*cosphase)/t_i',...
                    ...
                    ...
                    'dSus_1 = -(bet*Mt*Sus_1*Inft + ipd)',...
                    'dExp1_1= (bet*Mt*Sus_1*Inft + ipd)-((3*Exp1_1)/t_l)',...
                    ...
                    ...
                    'dSus_2 = -(bet*Mt*Sus_2*Inft + ipd)',...
                    'dExp1_2= (bet*Mt*Sus_2*Inft + ipd)-((3*Exp1_2)/t_l)',...
                    ...
                    ...
                    'dSus_3 = -(bet*Mt*Sus_3*Inft + ipd)',...
                    'dExp1_3= (bet*Mt*Sus_3*Inft + ipd)-((3*Exp1_3)/t_l)',...
                    ...
                    ...
                    'dSus_4 = -(bet*Mt*Sus_4*Inft + ipd)',...
                    'dExp1_4= (bet*Mt*Sus_4*Inft + ipd)-((3*Exp1_4)/t_l)',...
                    ...
                    ...
                    'dSus_5 = -(bet*Mt*Sus_5*Inft + ipd)',...
                    'dExp1_5= (bet*Mt*Sus_5*Inft + ipd)-((3*Exp1_5)/t_l)',...
                    ...
                    ...
                    'dSus_6 = -(bet*Mt*Sus_6*Inft + ipd)',...
                    'dExp1_6= (bet*Mt*Sus_6*Inft + ipd)-((3*Exp1_6)/t_l)',...
                    ...
                    ...
                    'dSus_7 = -(bet*Mt*Sus_7*Inft + ipd)',...
                    'dExp1_7= (bet*Mt*Sus_7*Inft + ipd)-((3*Exp1_7)/t_l)',...
                    ...
                    ...
                    'dSus_8 = -(bet*Mt*Sus_8*Inft + ipd)',...
                    'dExp1_8= (bet*Mt*Sus_8*Inft + ipd)-((3*Exp1_8)/t_l)',...
