...
NumDays = '1-sep-2020';
month2day = @(x) x*30+15;
cp = cos(2*pi*((daysact('1-jan-2020', NumDays)/365)-(month2day(0)/365)));
...
par=[327167434,3.2,0.1,month2day(0),pi,ipd,2,3,3,14,3,...
...
% par_names=char('Npop','R_0','epp','cosphase','ipd','ofs','t_i','t_l','t_c', 't_h'',...
%              'ze_0','m_0','c_0','f_0');  
