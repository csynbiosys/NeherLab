...
function [] = RUN_PE_COVID19_NoOver_V2_Spain(resultBase,nThetaGuesses,expdata)
    ...
    parfor epcc_exps=1:nThetaGuesses
        ...
        if ~ismember(m,fi)
            ...
            try
                ...
                [out] = PE_COVID19_NoOver_V2_Spain(epccOutputResultFileNameBase,epcc_exps,global_theta_guess,expdata,theta);
            catch err
                %open file
